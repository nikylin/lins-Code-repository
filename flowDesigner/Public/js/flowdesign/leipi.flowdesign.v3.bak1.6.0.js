...
(function ($) {
    ...
    $.fn.Flowdesign = function (options) {
        ...
        function eventBind() {
            ...
            //绑定删除connection事件
            jsPlumb.bind("connectionDetached", function (info) { //jsPlumbConnectionDetached
        ...
        var Flowdesign = {
            ...
            delProcess: function (activeId) {
                ...
                jsPlumb.detachAllConnections("window" + activeId); //删除activeId所有连接线
                jsPlumb.removeAllEndpoints("window" + activeId); //删除activeId所有端点
                jsPlumb.detach("window" + activeId); //删除连接线
                $("#window" + activeId).remove();
