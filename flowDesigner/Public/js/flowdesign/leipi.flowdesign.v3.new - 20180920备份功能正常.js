...
88           88  88           `"Ybbd8"'    88     88      Y88'     `"Y8888P'     "Y88888P"                                                 d8'                                
        ...
        var Flowdesign = {
            ...
            getProcessInfo: function () {
                try {
                    ...
                    // console.log(conns);
                    // for (var index = 0, len = conns.length; index < len; index++) {
                    //     var sourceId = conns[index].sourceId,
                    //         targetId = conns[index].targetId,
                    //         slen = sourceId.length,
                    //         tlen = targetId.length;

                    //     var sid = sourceId.substring(slen - 2, slen),
                    //         tid = targetId.substring(tlen - 2, tlen);
                    //     aProcessData[sid]["process_to"].push(tid);
                    // }
